...
curses_info = {'ИТМО 10.03.01': ['ИТМО', '10.03.01', 85, 71, None, None, None, 8, 6, 0, 259, 'ИМР'],
               ...
               'СПбПУ 09.03.03': ['СПбПУ', '09.03.03', 30, 17, None, None, None, 7, 3, 3, 260, 'МИР'],
               'СПбПУ 01.03.02': ['СПбПУ', '01.03.02', 55, 31, None, None, None, 19, 1, 4, 260, 'МИР'],
               'СПбПУ 09.03.02': ['СПбПУ', '09.03.02', 22, 20, None, None, None, 0, 0, 2, 260, 'МИР'],
               'СПбПУ 02.03.03': ['СПбПУ', '02.03.03', 36, 35, None, None, None, 1, 0, 0, 260, 'МИР'],
               ...
               'Бонч 09.03.04': ['Бонч', '09.03.04', 64, 56, 965, 37, 19, 0, 4, 4, 250, 'МРИ'],
               'Бонч 09.03.02': ['Бонч', '09.03.02', 41, 35, 620, 9, 26, 0, 4, 2, 250, 'МРИ'],
               'Бонч 10.03.01': ['Бонч', '10.03.01', 75, 62, 586, 22, 40, 0, 8, 5, 250, 'МРИ']}

for applicant in list_of_applicants:
    name = applicant['university'] + ' ' + applicant['curse']
    if applicant['admission'] == 'конкрус':
        if applicant['university'] == 'ЛЭТИ' and applicant['curse'] == '09.03.01':
            if applicant['curse_name'] == 'Информатика и вычислительная техника (Искусственный интеллект)':
                name = 'ЛЭТИ 09.03.01 ИИ'
                curses[name].append(applicant)
            elif applicant['curse_name'] == \
                    'Информатика и вычислительная техника (Компьютерное моделирование и проектирование)':
                name = 'ЛЭТИ 09.03.01 КМиП'
                curses[name].append(applicant)
        elif name in curses.keys():
            curses[name].append(applicant)
